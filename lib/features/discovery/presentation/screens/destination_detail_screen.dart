...
class DestinationDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String placeholderUrl =
        'https://loremflickr.com/1200/800/${Uri.encodeComponent(destination.name)},travel,landscape/all';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ...destination.highlights.asMap().entries.map((entry) {
                        ...
                        ).animate().fade(delay: Duration(milliseconds: 400 + (entry.key * 100))).slideX(begin: 0.05);
                      }),
                      const SizedBox(height: 12),
